...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String query=" CREATE TABLE products (ID INTEGER PRIMARY KEY, Name TEXT, Type INTEGER, Price INTEGER, ImageURL TEXT,Description TEXT, Quantity INTEGER, Fresh INTEGER)";
        db.execSQL(query);
    }
    ...
    public static String getColumnQuantity(){
