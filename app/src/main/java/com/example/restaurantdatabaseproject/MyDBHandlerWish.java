...
public class MyDBHandlerWish extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION=1;
    private static final String DATABASE_NAME="wishlistProducts.db";
    private static final String TABLE_PRODUCTS="wishlistProducts";
    ...
    public MyDBHandlerWish(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, DATABASE_NAME, factory, DATABASE_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        String query=" CREATE TABLE wishlistProducts (ID INTEGER PRIMARY KEY, Name TEXT, Type INTEGER, Price INTEGER, ImageURL TEXT,Description TEXT, Quantity INTEGER, Fresh INTEGER)";
        db.execSQL(query);
    }
    ...
    public void addWishProduct(Food food){
    ...
    public void deleteWishProduct(String productName){
        SQLiteDatabase db=getWritableDatabase();
        db.execSQL("DELETE FROM "+ TABLE_PRODUCTS+" WHERE "+COLUMN_NAME+"=\""+productName+"\";");
    }

    public void deleteAllWishProducts(){
        SQLiteDatabase db=getWritableDatabase();
